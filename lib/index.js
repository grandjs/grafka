...
exports.Topic = exports.useProducer = exports.Brokers = exports.UseConsumer = exports.Consumer = exports.UseBroker = exports.Broker = void 0;
...
const createTopicEvent = (broker) => {
    ...
    topics.map((topic) => {
        ...
        broker.EventEmitter.on(topic, (...args) => {
            ...
            Promise.all(customers.map((obj) => __awaiter(void 0, void 0, void 0, function* () { return obj.executer(...obj.arguments, ...args); })));
        });
        Promise.all(broker.consumers.map((obj) => __awaiter(void 0, void 0, void 0, function* () {
